<template>
  <article class="post">
    <h4 class="post-cat">
      <a href="/demo-autumn/categories/JavaScript/">JavaScript</a>
    </h4>

    <h2 class="post-title">Promise</h2>
    <ul class="post-date">
      <li>2017-07-06</li>
      <li>Sophie He</li>
    </ul>
    <div class="post-content">
      <p>
        ...
        <code>Promise.resolve(undefined)</code> as async callback is just local function.
      </p>
      <a id="more"/>
    ...
    <span class="hljs-built_in">console</span>.log(`<span class="javascript"><span class="hljs-number">5</span> then ${e}</span>`); <span class="hljs-regexp">//</span> <span class="hljs-number">5</span> <span class="hljs-keyword">then</span> what?
      ...
      <p>
        If you want to pass the parameters, return in the end line of then function. They will be wrapped as
        <code>Promise.resolve(your parameters)</code>, regardless of basic type or Object.
      </p>
      <p>
        When
        <code>catch()</code> does not return
        <code>Promise.reject(...)</code>, it will return
        <code>Promise.resolve(undefined)</code>. All the errors thrown halfway can be centralized processed in the final
        <code>catch()</code>.
      </p>
      <p>There is an interesting test online:</p>
      <pre><code class="hljs javascript">  doSomething().then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"/>) </span>{
  ...
  doSomething().then(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"/>) </span>{
    doSomethingElse();
  ...
  doSomething().then(
    ...
    <span
  class="hljs-comment"
>// this step will be ignored</span>
  ...
  doSomething().then(
    ...
    <span
  class="hljs-comment"
>// Promise.resolve(what doSomethingElse returns)</span>
